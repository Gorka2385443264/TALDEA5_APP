    ...
    private void initComponents() {
        ...
        btnmantenitzeBizikleta.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                // Obtener la ID del usuario de la instancia de mantenitze
                int idLangilea = getIdUsuario();
                System.out.println("ID del langilea en mantenitze: " + idLangilea);

                // Crear una instancia de la ventana konponduBizikletaMantenitze
                konponduBizikletaMantenitze ventanaKonponduBizikleta = new konponduBizikletaMantenitze(idLangilea);
