...
public class ordainketaHistorialaLangilea extends JFrame {
    ...
    public static void main(String[] args) {
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    ordainketaHistorialaLangilea frame = new ordainketaHistorialaLangilea();
    ...
    public ordainketaHistorialaLangilea() {
        ...
        JLabel lblNewLabel = new JLabel("Ordainketa Historiala");
        ...
        btnAtras.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                // Cerrar la ventana actual de katalogoaLangilea
                dispose();
            }
        });
